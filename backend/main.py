...
# -------------------------
# SSE streaming and sending email
# -------------------------
async def run_agent_and_stream(criteria: str, attributes: list[str], email: str):
    # Placeholder for results to include in email
    results = [
        {attr: f"Sample {attr}" for attr in attributes} for _ in range(5)
    ]
    ...
    # Send email
    html_content = build_email_content(criteria, attributes, results)
    send_email_report(email, "Your Investment Scout Report", html_content)
