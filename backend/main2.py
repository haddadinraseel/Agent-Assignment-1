"""backend/main2.py — clean duplicate of working backend implementation.

Contains minimal, conflict-free endpoints:
- /linkup_search: calls Linkup API (requires LINKUP_API_KEY in .env)
- /run_scout: SSE endpoint that runs discovery + deep dive and sends an email (SendGrid optional)
"""
...
app = FastAPI(title="Investment Sourcing Agent (main2)")
